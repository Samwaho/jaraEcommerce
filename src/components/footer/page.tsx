...
const Footer = () => {
  return (
    <div>
      <div className="text-main-text md:hidden bg-gradient-to-tr from-sky-400 to-sky-700 fixed bottom-0 w-full flex items-center justify-around">
        <Link href="/">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
              ...
              <div className="text-center sm:text-left">
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    <a
                      className="group flex justify-center gap-1.5 ltr:sm:justify-start"
                      href="#"
                    >
          ...
          <div className="mt-12 border-t border-gray-100 pt-6">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              <p className="text-sm text-gray-500">
                ...
                <a
                  className="inline-block text-sky-600 underline transition hover:text-sky-600/75"
                  href="#"
                >
                  Terms & Conditions
                </a>
