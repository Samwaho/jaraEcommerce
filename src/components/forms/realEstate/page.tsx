...
import { createRealEstate, getAuthSeller } from "@/lib/actions";
import { realEstateSchema } from "@/lib/zodSchemas";
...
const RealEstateForm = ({ categoryId, subCategoryId }: Props) => {
  ...
  const handleSubmit = async (values: z.infer<typeof realEstateSchema>) => {
    try {
