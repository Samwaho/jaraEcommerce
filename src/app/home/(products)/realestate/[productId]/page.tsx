      ...
      <div className=" -mt-4 bg-white shadow-md rounded-lg p-3 ">
        ...
        <div className="flex flex-col gap-2 bg-main-bg p-2 rounded-lg mt-2">
          <div className="flex items-center gap-10">
            ...
            <p className="bg-white rounded-md ms-8 px-2 w-full truncate">{realEstate?.title}</p>
          </div>
          <div className="flex items-center gap-10">
            <h4 className="font-semibold">Type:</h4>
            <p className="bg-white rounded-md ms-7 px-2 w-full truncate">{realEstate?.type}</p>
          </div>
          <div className="flex items-center gap-10">
            <h4 className="font-semibold">Size:</h4>
            <p className="bg-white rounded-md ms-9 px-2 w-full truncate">{realEstate?.size}</p>
          </div>
          <div className="flex items-center gap-10">
            <h4 className="font-semibold">Location:</h4>
            <p className="bg-white rounded-md px-2 w-full truncate">{realEstate?.location}</p>
          </div>
        </div>
